...
<body>
    ...
    <p><strong>$_myvar, $_7var, myvar, $myvar, $var7, $_element1, $house*5</strong></p>
    
    <?php
        echo "<h4>Respuesta:</h4>";
        echo "<ul>";
        echo "<li>\$_myvar es <strong>válida</strong> porque inicia con guión bajo.</li>";
        echo "<li>\$_7var es <strong>válida</strong> porque inicia con guión bajo.</li>";
        echo "<li>myvar es <strong>inválida</strong> porque no tiene el signo de dólar (\$).</li>";
        echo "<li>\$myvar es <strong>válida</strong> porque inicia con una letra.</li>";
        echo "<li>\$var7 es <strong>válida</strong> porque inicia con una letra.</li>";
        echo "<li>\$_element1 es <strong>válida</strong> porque inicia con guión bajo.</li>";
        echo "<li>\$house*5 es <strong>inválida</strong> porque el símbolo * no está permitido.</li>";
        echo "</ul>";
    ?>
    ...
    <?php
        // Recrear variables del ejercicio anterior
        $a = "PHP5";
        $z[] = &$a;
        $b = "5a version de PHP";
        $c = $b * 10;
    ...
    <?php
        ...
        if (isset($_SERVER['SERVER_SOFTWARE'])) {
            ...
            echo "<p>Servidor: No disponible</p>";
        }
        ...
        echo "<li>User Agent: " . (isset($_SERVER['HTTP_USER_AGENT']) ? substr($_SERVER['HTTP_USER_AGENT'], 0, 50) . '...' : 'No disponible') . "</li>";
        echo "</ul>";
    ?>
